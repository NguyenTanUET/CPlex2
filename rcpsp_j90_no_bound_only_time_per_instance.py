#!/usr/bin/env python3
"""
RCPSP solver that processes all .data files from j90_no_bound directory and outputs results to CSV.
...
This script:
1. Finds all .data files in the Convert/data/j90_no_bound directory
...
4. Records results in result/j90_no_bound.csv with columns:
...
def main():
    ...
    data_dir = Path("Convert/data/j90_no_bound")
    result_dir = Path("result")
    output_file = result_dir / "j90_no_bound.csv"
