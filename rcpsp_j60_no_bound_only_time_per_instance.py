#!/usr/bin/env python3
"""
RCPSP solver that processes all .data files from j60_no_bound directory and outputs results to CSV.
Each instance gets a fixed time limit and solves without using any provided bounds.

Usage:
    python rcpsp_j60_no_bound_only_time_per_instance.py

This script:
1. Finds all .data files in the Convert/data/j60_no_bound directory
...
4. Records results in result/j60_no_bound.csv with columns:
...
def main():
    ...
    data_dir = Path("Convert/data/j60_no_bound")
